...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        # LSTM layers
        self.encoder = nn.LSTM(embed_size, hidden_size=hidden_size, bidirectional=True, bias=True)
        self.decoder = nn.LSTMCell(embed_size + hidden_size, hidden_size=hidden_size, bias=True)
        # linear layers
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]]:
        ...
        # Final state to be passed to decoder
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        dec_hidden_usq = dec_hidden.unsqueeze(dim=2)
        e_t = enc_hiddens_proj.bmm(dec_hidden_usq).squeeze(dim=2)
